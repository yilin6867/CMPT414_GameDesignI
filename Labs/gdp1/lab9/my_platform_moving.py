...
class HorizontalMovingPlatform(MovingPlatform):
...
class VerticalMovingPlatform(MovingPlatform):
    def __init__(self, *args):
        super().__init__(*args)
        self.change_x = 0
        self.change_y = 1
...
class Level_01(Level):
    ...
    def __init__(self, player):
        ...
        block = HorizontalMovingPlatform(70, 40)
        block.rect.x = 550
        block.rect.y = 425
...
class Level_02(Level):
    ...
    def __init__(self, player):
        ...
        # Add a custom moving platform
        block = VerticalMovingPlatform(70, 70)
        block.rect.x = 550
        block.rect.y = 425
